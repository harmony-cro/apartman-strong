        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 lg:gap-12">
          {RULES.map((r, i) => (
            <div key={r.key} data-reveal style={{ transitionDelay: `${i * 80}ms` }}>
              <div className="flex h-full flex-col items-center rounded-xl border border-outline/20 bg-surface p-8 text-center shadow-[var(--shadow-card)] transition-transform duration-300 hover:-translate-y-1">
