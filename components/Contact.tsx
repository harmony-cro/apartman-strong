        ...
        <div className="space-y-8">
          ...
          <ul className="space-y-5">
            <li className="flex items-center gap-4">
              <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-surface-container text-accent">
                <Icon name="phone" className="h-5 w-5" />
              </span>
              <span>
                <span className="label-eyebrow block text-muted-foreground">{t('phone')}</span>
                <a href={`tel:${site.phone.tel}`} className="text-lg transition-colors hover:text-accent">{site.phone.display}</a>
              </span>
            </li>
            <li className="flex items-center gap-4">
              <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-surface-container text-accent">
